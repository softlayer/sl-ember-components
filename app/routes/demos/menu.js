...
export default Ember.Route.extend({
    ...
    model: function() {
        return  Ember.Object.create({ label: null, items: Ember.A([
            Ember.Object.create({ label: 'Colors', items: Ember.A([
            ...
            Ember.Object.create({ label: 'Numbers', items: Ember.A([
                Ember.Object.create({ label: '1-5', items: Ember.A([
                ...
                Ember.Object.create({ label: '6-10', items: Ember.A([
            ...
            Ember.Object.create({ label: 'Cities', items: Ember.A([
                Ember.Object.create({ label: 'Texas', items: Ember.A([
                ...
                Ember.Object.create({ label: 'Oklahoma', items: Ember.A([
                    Ember.Object.create({ label: 'Oklahoma City' }),
                    Ember.Object.create({ label: 'Norman' })
                ])}),
                Ember.Object.create({ label: 'California', items: Ember.A([
