...
import SlButtonTemplate       from '../templates/components/sl-button';
import SlCalendarComponent    from '../components/sl-calendar';
import SlCalendarTemplate     from '../templates/components/sl-calendar';
import SlCheckboxComponent    from '../components/sl-checkbox';
import SlCheckboxTemplate     from '../templates/components/sl-checkbox';
import SlDropbuttonComponent  from '../components/sl-dropbutton';
import SlDropbuttonTemplate   from '../templates/components/sl-dropbutton';
import SlGridComponent        from '../components/sl-grid';
import SlGridTemplate         from '../templates/components/sl-grid';
import SlInputComponent       from '../components/sl-input';
import SlInputTemplate        from '../templates/components/sl-input';
import SlSelectComponent      from '../components/sl-select';
import SlSelectDateComponent  from '../components/sl-selectdate';
import SlSelectDateTemplate   from '../templates/components/sl-selectdate';
import SlSelectTemplate       from '../templates/components/sl-select';
import SlSimpleModalComponent from '../components/sl-simplemodal';
import SlSimpleModalTemplate  from '../templates/components/sl-simplemodal';
import SlTabPanelComponent    from '../components/sl-tabpanel';
import SlTabPanelTemplate     from '../templates/components/sl-tabpanel';
import SlTextareaComponent    from '../components/sl-textarea';
import SlTextareaTemplate     from '../templates/components/sl-textarea';
